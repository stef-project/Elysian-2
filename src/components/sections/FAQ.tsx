...
const faqs = [
  ...
  },
  {
    ...
    a: "At Elysian Institute, manual lymphatic drainage starts at £120 for one zone (legs or abdomen) and £240 for two zones.",
  },
  {
...
export function FAQ() {
  return (
    <section id="faq" className="py-32 bg-[#F7F5F2] overflow-hidden">
